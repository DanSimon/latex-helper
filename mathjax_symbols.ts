...
export const LATEX_SYMBOLS = [
    ...
    },
    {
        ...
        examples: "",
        see_also: ["<code>\\And</code>"],
        snippet: "",
    },
    {
        name: "\\\\",
        description: "line separator in alignment modes and environments",
        examples: ["\\begin{gather}a\\\\a+b\\\\a+b+c\\end{gather}"],
        see_also: [],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        examples: ["{1,2,3}", "\\{1,2,3\\}", "\\left\\{\\frac ab,c\\right\\}"],
        see_also: ["\\brace", "\\lbrace", "\\rbrace"],
        snippet: "",
    },
    {
        name: "|",
    ...
    },
    {
        ...
        description:
            "parentheses;\nnon-stretchy when used alone; stretchy when used with \u00a0 \\left \u00a0 or \u00a0 \\right\n\n( is class OPEN;\n) is class CLOSE",
        examples: ["(\\frac ab,c)", "\\left(\\frac ab,c\\right)"],
        see_also: [],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        examples: ["\\acute e", "\\acute E", "\\acute eu", "\\acute{eu}"],
        see_also: [],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        examples: ["a \\atop b", "a+1 \\atop b+2", "{a+1 \\atop b+2}+c"],
        see_also: [
            "\\above",
            "\\abovewithdelims",
            "\\atopwithdelims",
    ...
    },
    {
        ...
        examples: ["\\bar x", "\\bar X", "\\bar xy", "\\bar{xy}"],
        see_also: [],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        see_also: ["\\binom", "\\choose", "\\dbinom", "\\tbinom"],
        snippet: "\\binom{@1@}{@2@}",
    },
    {
        name: "\\blacklozenge",
    ...
    },
    {
        ...
        description:
            "breve accent\n\n&#x02D8;\n\n\\breve #1\nUsually, #1 is a single letter; \u00a0otherwise, accent is centered over argument.",
        examples: ["\\breve e", "\\breve E", "\\breve eu", "\\breve{eu}"],
        see_also: [],
        snippet: "",
    },
    {
    ...
    },
    {
        name: "\\cdot",
        description: "&#x22C5; \u00a0\nclass BIN\ncentered dot",
        examples: ["a\\cdot b", "a\\cdotp b", "a\\centerdot b"],
        see_also: ["\\cdotp", "\\cdots", "\\centerdot"],
        snippet: "",
    },
    {
        name: "\\cdotp",
        ...
        examples: ["\\rm s \\cdot h", "\\rm s \\cdotp h"],
        see_also: ["\\cdot", "\\centerdot"],
        snippet: "",
    },
    {
        name: "\\cdots",
    ...
    },
    {
        ...
        description:
            "&#x02C7;\ncheck accent\n\\check #1\nUsually, #1 is a single letter; \u00a0otherwise, accent is centered over argument.",
        examples: ["\\check o", "\\check O", "\\check oe", "\\check{oe}"],
        see_also: [],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        examples: ["3 \\choose 2"],
        see_also: ["\\binom", "\\dbinom", "\\tbinom"],
        snippet: "@1@ \\choose @2@",
    },
    {
        name: "\\circ",
        description: "&#x2218; \u00a0\nclass BIN",
        examples: ["(f\\circ g)(x) = f(g(x))", "45^\\circ"],
        see_also: [],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        examples: ["ab\\class{smHighlightRed}{cdef}gh"],
        see_also: [],
        snippet: "",
    },
    {
        ...
        description: "&#x2663; \u00a0\nclass ORD",
        examples: "",
        see_also: ["\\diamondsuit", "\\heartsuit", "\\spadesuit"],
        snippet: "",
    },
    {
        name: "\\colon",
        ...
        examples: ["f:A\\to B", "f\\colon A\\to B"],
        see_also: [],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        description: "&#x2662; \u00a0 class ORD",
        examples: "",
        see_also: ["\\clubsuit", "\\heartsuit", "\\spadesuit"],
        snippet: "",
    },
    {
        name: "\\digamma",
    ...
    },
    {
        ...
        examples: "",
        see_also: ["\\textstyle", "\\scriptstyle", "\\scriptscriptstyle"],
        snippet: "",
    },
    {
        name: "\\div",
    ...
    },
    {
        ...
        examples: "",
        see_also: ["\\leftharpoondown", "\\leftharpoonup"],
        snippet: "",
    },
    {
        name: "\\ell",
    ...
    },
    {
        ...
        examples: "",
        see_also: ["\\eqalignno", "align environment", "\\tag"],
        snippet: "",
    },
    {
        name: "\\eqalignno",
        ...
        examples: "",
        see_also: ["\\eqalign", "\\leqalignno", "align environment"],
        snippet: "",
    },
    {
        name: "\\eqcirc",
    ...
    },
    {
        ...
        examples: ["\\boxed{Hi there!}", "\\fbox{Hi there!}"],
        see_also: ["\\boxed"],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        description: "&#x2322; \u00a0\nclass REL",
        examples: "",
        see_also: ["\\smallfrown", "\\smallsmile", "\\smile"],
        snippet: "",
    },
    {
        name: "\\Game",
    ...
    },
    {
        ...
        examples: ["\\genfrac(]{0pt}{2}{a+b}{c+d}"],
        see_also: [
            "\\above",
            "\\abovewithdelims",
            "\\atop",
    ...
    },
    {
        ...
        description:
            "&#x02CB;\ngrave accent\n\\grave #1\nUsually, #1 is a single letter; \u00a0otherwise, accent is centered over argument.",
        examples: ["\\grave e", "\\grave E", "\\grave eu", "\\grave{eu}"],
        see_also: [],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        examples: ["\\hat\\imath", "\\hat\\jmath", "\\hat ab", "\\hat{ab}"],
        see_also: ["\\widehat"],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        description: "&#x2661; \u00a0\nclass ORD",
        examples: "",
        see_also: ["\\clubsuit", "\\diamondsuit", "\\spadesuit"],
        snippet: "",
    },
    {
        name: "\\hfil",
    ...
    },
    {
        ...
        examples: ["\\href{http://www.onemathematicalcat.org}{M^{A^{T^H}}}"],
        see_also: [],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        description:
            "&#x222B; (with movable limits) \u00a0\nclass OP\n\nSee the Big Operators Table for examples.",
        examples: "",
        see_also: ["\\iiiint, \\iiint, \\iint, \\int"],
        snippet: "",
    },
    {
        name: "\\Im",
    ...
    },
    {
        ...
        examples: ["\\inf_{\\rm limit}", "\\inf_{\\rm limit}"],
        see_also: ["\\sup"],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        examples: "",
        see_also: ["\\eqalignno", "align environment"],
        snippet: "",
    },
    {
        name: "\\lessapprox",
    ...
    },
    {
        ...
        examples: ["\\left\\lvert\\frac{\\frac ab}{\\frac cd}\\right\\rvert"],
        see_also: ["\\rvert", "\\rVert", "|", "\\|"],
        snippet: "",
    },
    {
        name: "\\lvertneqq",
    ...
    },
    {
        ...
        examples: ["ab\\text{inside}cd", "ab\\mathinner{\\text{inside}}cd"],
        see_also: [],
        snippet: "",
    },
    {
        ...
        examples: ["\\rm abc \\mathit{def} ghi"],
        see_also: [],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        examples: ["1.234", "1\\mathpunct{.}234"],
        see_also: [],
        snippet: "",
    },
    {
    ...
    },
    {
        name: "\\mathring",
        description: "&#x2DA;\n\n\\mathring #1",
        examples: ["\\mathring A", "\\mathring{AB}C"],
        see_also: [],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        description:
            "maximum;\ndoes not change size;\ncan change limit placement using \u00a0\\limits\u00a0 and\n\u00a0\\nolimits;\nsee the Big Operators Table for examples\n\nclass OP",
        examples: ["\\max_{\\rm sub}", "\\max_{\\rm sub}"],
        see_also: ["\\min"],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        examples: ["\\{x | x\\gt 1\\}", "\\{x \\mid x\\gt 1\\}"],
        see_also: ["\\nmid", "\\shortmid", "\\nshortmid"],
        snippet: "",
    },
    {
        ...
        description:
            "minimum;\ndoes not change size;\ncan change limit placement using \u00a0\\limits\u00a0 and\n\u00a0\\nolimits;\nsee the Big Operators Table for examples\n\nclass OP",
        examples: ["\\min_{\\rm sub}", "\\min_{\\rm sub}"],
        see_also: ["\\max"],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        examples: ["ab", "a\\mkern18mu b", "a\\mkern18pt b"],
        see_also: [],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        examples: ["ab", "a\\mskip18mu b", "a\\mskip18pt b"],
        see_also: [],
        snippet: "",
    },
    {
        ...
        examples: ["ab", "a\\mspace18mu b", "a\\mspace18pt b"],
        see_also: [],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        description: "&#x21AE; \u00a0 class REL\n&#x21CE; \u00a0 class REL",
        examples: "",
        see_also: ["\\leftrightarrow", "\\Leftrightarrow"],
        snippet: "",
    },
    {
        name: "\\nleq",
    ...
    },
    {
        ...
        description: "&#x219B; \u00a0 class REL\n&#x21CF; \u00a0 class REL",
        examples: "",
        see_also: ["\\rightarrow", "\\Rightarrow"],
        snippet: "",
    },
    {
        name: "\\nshortmid",
    ...
    },
    {
        ...
        description: "",
        examples: "",
        see_also: ["\\parallel", "\\shortparallel", "REL"],
        snippet: "",
    },
    {
        name: "\\nsim",
    ...
    },
    {
        ...
        description: "&#x22EA; \u00a0 class REL\n&#x22EC; \u00a0 class REL",
        examples: "",
        see_also: ["\\triangleleft", "\\trianglelefteq"],
        snippet: "",
    },
    {
        name: "\\ntriangleright",
        description: "&#x22EB; \u00a0  class REL\n&#x22ED; \u00a0  class REL",
        examples: "",
        see_also: ["\\triangleright", "\\trianglerighteq"],
        snippet: "",
    },
    {
        name: "\\nu",
    ...
    },
    {
        ...
        examples: ["\\operatorname{myFct}(x)", "\\operatorname*{myFct}_a^b(x)"],
        see_also: [],
        snippet: "",
    },
    {
        ...
        examples: ["a \\over b", "a+1 \\over b+2", "{a+1 \\over b+2}+c"],
        see_also: [
            "\\above",
            "\\abovewithdelims",
            "\\atop",
    ...
    },
    {
        name: "\\overparen",
        description:
            "puts a (stretchy) over-parenthesis (over-arc, frown) over the argument (new in MathJax 2.6)\n\\overparen #1",
        examples: [
    ...
    },
    {
        name: "\\partial",
        description: "",
        examples: ["\\frac{\\partial f}{\\partial x}"],
        see_also: [],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        examples: ["a \\pmb a \\boldsymbol a", "\\pmb{a+b-c}\\ \\ a+b-c"],
        see_also: [],
        snippet: "",
    },
    {
        ...
        examples: ["5\\equiv 8 \\pmod 3", "\\pmod{n+m}"],
        see_also: ["\\mod", "\\bmod"],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        description:
            "does not change size;\ndefault limit placement can be changed using \u00a0\\limits\u00a0 and  \u00a0\\nolimits;\ndoes not change size;\nsee the Big Operators Table for more examples\n\nclass OP",
        examples: ["\\Pr_{\\rm sub}", "\\Pr_{\\rm sub}"],
        see_also: [],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        examples: ["f'", "f\\prime", "f^\\prime", "f^{\\prime\\prime}", "f''"],
        see_also: ["\\backprime", "prime symbol"],
        snippet: "",
    },
    {
        name: "\\prod",
        description:
            "changes size;\ncan change limit placement using \\limits and\n\\nolimits;\nsee the Big Operators Table for more examples\n\n&#x220F; \u00a0\nclass OP",
        examples: ["\\prod_{j=1}^n", "\\prod_{j=1}^n"],
        see_also: [],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        examples: ["|\\quad|\\quad|", "|\\qquad\\hphantom{|}|"],
        see_also: [],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        description:
            "non-stretchy&#x21C1; \u00a0 class REL\nnon-stretchy&#x21C0; \u00a0 class REL",
        examples: "",
        see_also: ["\\leftharpoondown", "\\rightharpoondown"],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        examples: "",
        see_also: ["\\displaystyle", "\\scriptstyle", "\\textstyle"],
        snippet: "",
    },
    {
        name: "\\scriptsize",
    ...
    },
    {
        ...
        examples: "",
        see_also: ["\\displaystyle", "\\scriptscriptstyle", "\\textstyle"],
        snippet: "",
    },
    {
        name: "\\searrow",
    ...
    },
    {
        ...
        examples: ["A\\setminus B", "A\\backslash B"],
        see_also: ["\\backslash"],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        examples: ["\\sideset{_1^2}{_3^4}\\sum"],
        see_also: [],
        snippet: "",
    },
    {
        ...
        examples: "",
        see_also: ["\\sum", "\\varsigma", "\\varSigma"],
        snippet: "",
    },
    {
        name: "\\sim",
    ...
    },
    {
        ...
        examples: ["ab{\\small cd} cd", "ab\\small{cd} cd"],
        see_also: [
            "\\tiny",
            "\\Tiny",
            "\\normalsize",
    ...
    },
    {
        ...
        examples: "",
        see_also: ["\\frown", "\\smile", "\\smallsmile"],
        snippet: "",
    },
    {
        name: "\\smallint",
    ...
    },
    {
        ...
        examples: "",
        see_also: ["\\smile", "\\frown", "\\smallfrown"],
        snippet: "",
    },
    {
        name: "\\smash",
        ...
        see_also: ["\\hphantom", "\\vphantom", "\\phantom", "\\llap", "\\rlap"],
        snippet: "",
    },
    {
        name: "\\smile",
        description: "smile\n\n&#x2323; \u00a0\nclass REL",
        examples: "",
        see_also: ["\\smallsmile", "\\frown", "\\smallfrown"],
        snippet: "",
    },
    {
        name: "\\space",
    ...
    },
    {
        ...
        description: "",
        examples: "",
        see_also: ["\\clubsuit", "\\diamondsuit", "\\heartsuit", "ORD"],
        snippet: "",
    },
    {
        name: "\\sphericalangle",
    ...
    },
    {
        ...
        examples: ["\\sqrt x", "\\sqrt xy", "\\sqrt{xy}", "\\sqrt[3]{x+1}"],
        see_also: ["\\root"],
        snippet: "",
    },
    {
    ...
    },
    {
        name: "\\strut",
        description:
            "an invisible box with no width, height 8.6pt and depth 3pt;\nnote that \u00a0 \\mathstrut \u00a0 changes with the current size, but\n\u00a0 \\strut \u00a0 does not",
        examples: [
    ...
    },
    {
        ...
        description:
            "supremum;\nleast upper bound;\ndoes not change size;\ncan change limit placement using \\limits and  \\nolimits;\nsee the Big Operators Table for examples\n\nclass OP",
        examples: ["\\sup_{\\rm limit}", "\\sup_{\\rm limit}"],
        see_also: ["\\inf"],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        examples: "",
        see_also: ["\\displaystyle", "\\scriptstyle", "\\scriptscriptstyle"],
        snippet: "",
    },
    {
        name: "\\tfrac",
        description: "textstyle fraction\n\\tfrac #1 #2",
        examples: ["\\tfrac ab \\frac ab", "\\tfrac ab \\frac ab"],
        see_also: ["\\frac", "\\dfrac"],
        snippet: "",
    },
    {
    ...
    },
    {
        ...
        examples: ["\\tilde e", "\\tilde E", "\\tilde eu", "\\tilde{eu}"],
        see_also: [],
        snippet: "",
    },
    {
    ...
    },
    {
        name: "\\underparen",
        description:
            "puts a (stretchy) under-parenthesis (under-arc, smile) under the argument (new in MathJax 2.6)\n\\underparen #1",
        examples: [
    ...
    },
    {
        ...
        examples: ["\\underset{\\rm bottom}{\\rm top}", "\\underset ab"],
        see_also: ["\\overset"],
    ...
    },
    {
        ...
        examples: "",
        see_also: ["\\varupsilon", "\\varUpsilon"],
        snippet: "",
    },
    {
        name: "\\upuparrows",
    ...
    },
    {
        name: "\\varlimsup",
        description:
            "limit superior; variant\nclass OP\n\nlimit inferior; variant\nclass OP\n\ndo not change size;\ncan change limit placement using \u00a0\\limits\u00a0 and\n\u00a0\\nolimits;\nsee the Big Operators Table for examples",
        examples: "",
        see_also: ["\\limsup", "\\liminf"],
        snippet: "",
    },
    {
        name: "\\varnothing",
    ...
    },
    {
        ...
        description:
            "&#x25B3; \u00a0 class REL\n&#x22B2; \u00a0 class REL\n&#x22B3; \u00a0 class REL",
        examples: "",
        see_also: ["\\triangle", "\\triangleleft", "\\triangleright"],
        snippet: "",
    },
    {
        name: "\\varUpsilon",
    ...
    },
    {
        ...
        examples: ["\\vec v", "\\vec{AB}"],
        see_also: ["\\overrightarrow"],
        snippet: "",
    },
    {
        name: "\\vee",
    ...
    },
    {
        ...
        examples: "",
        see_also: ["|", "\\|", "\\lvert", "\\lVert", "\\rvert", "\\rVert"],
        snippet: "",
    },
    {
        name: "\\vphantom",
        ...
        examples: ["\\binom{\\frac ab}c  \\binom{\\vphantom{\\frac ab}?}c"],
        see_also: ["\\phantom", "\\hphantom", "\\smash"],
        snippet: "",
    },
    {
        name: "\\Vvdash",
    ...
    },
    {
        ...
        examples: "",
        see_also: ["\\eqalign", "\\eqalignno", "\\leqalignno"],
        snippet: "\\begin{align}\n\t@1@\n\\end{align}",
    },
    {
        name: "align*",
    ...
    },
    {
        ...
        examples: "",
        see_also: ["\\eqalignat", "\\eqalignatno", "\\leqalignatno"],
    ...
    },
    {
        ...
        examples: "",
        see_also: ["\\begin{matrix}", "\\begin{subarray}"],
        snippet: "\\begin{array}\n\t@1@\n\\end{array}",
    },
    {
        name: "Bmatrix",
        ...
        see_also: ["\\begin{array}", "\\begin{matrix}"],
    ...
    },
    {
        name: "split",
        description:
            "for single equations that are too long to \ufb01t on one line, and hence must be split into multiple lines;\nallows for (optional) alignment at one or more places, using \u2018&\u2019 to mark alignment points",
        examples: "",
        see_also: ["\\begin{multline}"],
        snippet: "\\begin{split}\n\t@1@\n\\end{split}",
    },
    {
        name: "subarray",
