...
export class ConfigView extends ItemView {
    ...
    async onOpen() {
        ...
        const patternsContainer = container.createEl("div", {
            cls: "patterns-container",
        });
        ...
        const categories = this.groupPatternsByCategory(
        ...
        const renderPatterns = (searchTerm: string = "") => {
            ...
            for (const [category, patterns] of Object.entries(categories)) {
                ...
                const categoryEl = patternsContainer.createEl("div", {
                    cls: "category",
                });
                ...
                filteredPatterns.forEach((pattern) => {
                    pattern.replacements.forEach((replacement, idx) => {
                        ...
                        patternCell.style.borderBottom =
                            idx === pattern.replacements.length - 1
                        ...
                        previewCell.style.borderBottom =
                            patternCell.style.borderBottom;
